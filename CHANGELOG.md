...
* check programs before execution ([293ae20](https://github.com/ImAbhishekTomar/kora-lang/commit/293ae20cfb2018ebac93d019a5257c1e314f2245))
...
* **models:** name a model the way its provider names it ([d7d45ec](https://github.com/ImAbhishekTomar/kora-lang/commit/d7d45ec1396a51144e4a8584a112c146204667f3))
* **models:** reach any OpenAI-compatible gateway from kora.toml ([d2f7aa3](https://github.com/ImAbhishekTomar/kora-lang/commit/d2f7aa35e5cd11abcb75ba8b975f854362da4739))
...
* a budget that runs out inside a tool loop is a value, not a crash ([338b423](https://github.com/ImAbhishekTomar/kora-lang/commit/338b4231fff4a7c304b3b8c27eaaed2842292692))
* check tool parameter shapes before the run, not during it ([7fb61be](https://github.com/ImAbhishekTomar/kora-lang/commit/7fb61be04b1fc32c0387ca922c06f3d7f8a8d29f))
...
* **deps:** update rustls past RUSTSEC-2026-0285 ([6e065f9](https://github.com/ImAbhishekTomar/kora-lang/commit/6e065f94c7de9ea8fa7af669fc0dbc7d514868c9))
* **helper:** compose the seccomp opcodes from named bits ([009486c](https://github.com/ImAbhishekTomar/kora-lang/commit/009486cf9f350bc76f8637374fca4362c4890843))
...
* **models:** make the endpoint defaults code, not bare URLs ([650046c](https://github.com/ImAbhishekTomar/kora-lang/commit/650046c4470c2e05e521215bd3f9084ec4f7461e))
* **models:** name the prefix a bare gateway model id is missing ([dc4d067](https://github.com/ImAbhishekTomar/kora-lang/commit/dc4d0677a48258a4ff94945cedd0ccaf09924424))
...
* preserve durable model replay state ([6d41c95](https://github.com/ImAbhishekTomar/kora-lang/commit/6d41c95ece9f822d0a8745ee8d6474c0ab89dbbb))
...
* **site:** raise the js-yaml and smol-toml pins past their advisories ([d638dad](https://github.com/ImAbhishekTomar/kora-lang/commit/d638dad0c02dd62c9021eb4bb9b23254beab8794))
* **styles:** add Nextra background color variables for navbar and mobile menu ([0deb950](https://github.com/ImAbhishekTomar/kora-lang/commit/0deb950b022664c2c6648b653c2beac763cccae3))
...
* **vscode:** highlight first in parallel for ... first ([8ae875f](https://github.com/ImAbhishekTomar/kora-lang/commit/8ae875f56ca0129800fe20a87cb9d69048aa147b))
...
* add the 0.3.0 release page and index it ([82ca797](https://github.com/ImAbhishekTomar/kora-lang/commit/82ca797e1abfa488ba8f699ccfec9aa8a67d22fe))
...
* point the 0.3.0 version row at the release history ([f25021c](https://github.com/ImAbhishekTomar/kora-lang/commit/f25021cfcfb95e8a2e05c0d85d67fe062cd75f94))
...
* send the README links to the site that exists ([26f4513](https://github.com/ImAbhishekTomar/kora-lang/commit/26f451322edb99d1cde291b3d74ffa03734bf2d8))
