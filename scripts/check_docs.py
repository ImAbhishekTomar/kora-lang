...
DOCS = [
    ...
    ("site/app/outcomes/page.mdx", SITE),
    ("site/app/safety/page.mdx", SITE),
    ("site/app/agents/page.mdx", SITE),
    ("site/app/tools/page.mdx", SITE),
    ("site/app/testing/page.mdx", SITE),
    ("site/app/examples/page.mdx", SITE),
    ("site/app/stdlib/page.mdx", SITE),
    ("site/app/reference/page.mdx", SITE),
    ("site/app/roadmap/page.mdx", SITE),
    ("site/app/releases/page.mdx", SITE),
    ("site/app/releases/0.3.1/page.mdx", SITE),
    ("site/app/releases/0.3.0/page.mdx", SITE),
